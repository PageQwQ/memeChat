...
/**
 * 过渡式 A（1.21.2~1.21.5）表情包 glyph：扩展 BakedGlyph 类（渲染由父类
 * GlyphInstance 机制完成），自身实现 GlyphInfo 提供排版宽度。
 * BakedGlyph 构造参数顺序：u0,u1,v0,v1,left,right,up,down。
 */
public class MemechatGlyph extends BakedGlyph implements GlyphInfo {
    ...
    public MemechatGlyph(GlyphRenderTypes glyphRenderTypes, float aspectRatio) {
