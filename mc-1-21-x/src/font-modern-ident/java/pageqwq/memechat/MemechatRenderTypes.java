...
public final class MemechatRenderTypes {
    ...
    private static final Function<Identifier, GlyphRenderTypes> EMOJI_TEXTURED = Util.memoize(
            texture -> GlyphRenderTypes.createForColorTexture(texture)
    );

    public static GlyphRenderTypes emojiTextured(Identifier atlasTexture) {
